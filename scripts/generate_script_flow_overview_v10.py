...
# -*- coding: utf-8 -*-
"""
Generate script-flow-overview.svg v10:
- add parallel_run -> run_summary edge
- simplify run_genus -> dc_rep_dir path
- adjust labels for APR area
"""
import os

OUT = os.path.join(os.path.dirname(__file__), '..', 'synthesis-integration-flow-guide', 'script-flow-overview-v10.svg')
