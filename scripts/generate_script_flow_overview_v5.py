...
# -*- coding: utf-8 -*-
"""
Generate script-flow-overview.svg v5:
- white node backgrounds with layer-colored borders (no pink fill)
- orthogonal routing that avoids crossing nodes and labels
- labels placed beside paths, not on top of nodes
"""
import os

OUT = os.path.join(os.path.dirname(__file__), '..', 'synthesis-integration-flow-guide', 'script-flow-overview-v5.svg')
...
EDGES = [
    ("design.set", "compile_dc", "purple", "source",
     "M 340,104 L 700,104 L 700,264 L 640,264", (520,174)),
    ("run_ckf", "run_dc", "gray", "",
    ...
    ("dc_rep_dir", "pt_setup_pre", "green", ".gv + ip_cons",
     "M 910,312 L 910,560 L 660,560 L 660,616", (785,436)),
