...
# -*- coding: utf-8 -*-
"""
Generate script-flow-overview.svg v7:
- wider and taller canvas (1400x1100) to eliminate crowding
- white nodes with layer-colored borders
- orthogonal routing with labels verified against node overlap
"""
import os

OUT = os.path.join(os.path.dirname(__file__), '..', 'synthesis-integration-flow-guide', 'script-flow-overview-v7.svg')
...
EDGES = [
    ...
    ("run_genus", "dc_rep_dir", "red", "替代",
     "M 640,331 L 700,331 L 700,287 L 800,287", (720,320)),
    ...
    ("rtl_gate", "signoff", "blue", "等价通过",
     "M 520,416 L 520,516 L 400,516", (460,480)),
    ...
    ("write_sdc", "sdc_pr", "green", "SDC",
     "M 920,616 L 1000,616", (960,600)),
    ("sdc_pr", "apr", "green", "供 APR",
     "M 1090,594 L 1110,544", (1150,570)),
    ("apr", "pt_setup_post", "green", "网表+spef+postcts SDC",
     "M 1110,544 L 1110,560 L 980,560 L 980,688 L 960,688", (980,660)),
    ...
    ("get_pl", "merge_pl", "blue", "",
     "M 890,853 L 960,853", None),
    ("merge_pl", "report_csv", "green", "csv",
     "M 1110,853 L 1150,853", (1120,840)),
]
