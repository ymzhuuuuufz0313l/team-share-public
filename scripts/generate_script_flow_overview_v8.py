...
# -*- coding: utf-8 -*-
"""
Generate script-flow-overview.svg v8:
- keep 1400x1100 canvas
- fix arrow direction for sdc_pr -> APR (add a corner for clarity)
- move all labels to keep >=20px from any node edge
"""
import os

OUT = os.path.join(os.path.dirname(__file__), '..', 'synthesis-integration-flow-guide', 'script-flow-overview-v8.svg')
...
EDGES = [
    ...
    ("write_sdc", "sdc_pr", "green", "SDC",
     "M 920,616 L 1000,616", (960,580)),
    ("sdc_pr", "apr", "green", "供 APR",
     "M 1090,594 L 1090,570 L 1110,570 L 1110,544", (1130,570)),
    ("apr", "pt_setup_post", "green", "网表+spef+postcts SDC",
     "M 1110,544 L 1110,560 L 980,560 L 980,688 L 960,688", (980,560)),
    ...
    ("merge_pl", "report_csv", "green", "csv",
     "M 1110,853 L 1150,853", (1120,820)),
]
