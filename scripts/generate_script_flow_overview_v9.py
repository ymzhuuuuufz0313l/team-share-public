...
# -*- coding: utf-8 -*-
"""
Generate script-flow-overview.svg v9:
- re-route sdc_pr -> APR to avoid crossing with APR -> pt_setup_post
- keep 1400x1100 canvas and white nodes
- all labels verified no overlap
"""
import os

OUT = os.path.join(os.path.dirname(__file__), '..', 'synthesis-integration-flow-guide', 'script-flow-overview-v9.svg')
